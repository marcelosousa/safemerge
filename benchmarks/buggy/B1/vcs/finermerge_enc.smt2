...
(assert (forall ((ro Int) (ra Int) (rb Int) (rm Int) (xo Int) (xa Int) (xb Int) (xm Int) (xa1 Int) (xm1 Int)) (=> (Q_n0_1 ro ra rb rm xo xa xb xm) true)))
...
(assert (forall ((ro Int) (ra Int) (rb Int) (rm Int) (xo Int) (xa Int) (xb Int) (xm Int) (xb1 Int) (xm1 Int)) (=> (Q_n1_1 ro ra rb rm xo xa xb xm) true)))
