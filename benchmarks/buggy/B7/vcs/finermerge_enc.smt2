...
(assert (forall ((wo Int) (wa Int) (wb Int) (wm Int) (xo Int) (xa Int) (xb Int) (xm Int) (yo Int) (ya Int) (yb Int) (ym Int)) (=> (Q_n2 wo wa wb wm xo xa xb xm yo ya yb ym) (and (and (or (= wo wa) (= wm wa)) (or (= wo wb) (= wm wb)) (or (not (= wo wa)) (not (= wo wb)) (= wm wo))) (and (or (= xo xa) (= xm xa)) (or (= xo xb) (= xm xb)) (or (not (= xo xa)) (not (= xo xb)) (= xm xo))) (and (or (= yo ya) (= ym ya)) (or (= yo yb) (= ym yb)) (or (not (= yo ya)) (not (= yo yb)) (= ym yo)))))))
(check-sat)
