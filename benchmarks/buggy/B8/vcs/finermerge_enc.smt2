...
(assert (forall ((ro Int) (ra Int) (rb Int) (rm Int) (xo Int) (xa Int) (xb Int) (xm Int) (yo Int) (ya Int) (yb Int) (ym Int)) (=> (and (= xm 1) (= xb 1) (= xa 1) (= xo 1) (Q_n1_a ro ra rb rm xo xa xb xm yo ya yb ym)) (Q_n1_1 ro ra rb rm xo xa xb xm yo ya yb ym))))
...
(assert (forall ((ro Int) (ra Int) (rb Int) (rm Int) (xo Int) (xa Int) (xb Int) (xm Int) (yo Int) (ya Int) (yb Int) (ym Int)) (=> (and (not (= xm 1)) (not (= xb 1)) (not (= xa 1)) (not (= xo 1)) (Q_n2_a ro ra rb rm xo xa xb xm yo ya yb ym)) (Q_n2_1 ro ra rb rm xo xa xb xm yo ya yb ym))))
