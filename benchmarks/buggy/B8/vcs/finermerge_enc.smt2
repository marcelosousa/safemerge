...
(assert (forall ((go Int) (ga Int) (gb Int) (gm Int) (gradeo Int) (gradea Int) (gradeb Int) (gradem Int) (ro Int) (ra Int) (rb Int) (rm Int)) (=> (Q_n0 go ga gb gm gradeo gradea gradeb gradem ro ra rb rm) (Q_n0_1 go ga gb gm gradeo gradea gradeb gradem ro ra rb rm))))
(assert (forall ((go Int) (ga Int) (gb Int) (gm Int) (gradeo Int) (gradea Int) (gradeb Int) (gradem Int) (ro Int) (ra Int) (rb Int) (rm Int) (gb1 Int) (gm1 Int)) (=> (and (= gm1 2) (= gb1 2) (Q_n0_1 go ga gb gm gradeo gradea gradeb gradem ro ra rb rm)) (Q_n1 go ga gb1 gm1 gradeo gradea gradeb gradem ro ra rb rm))))
(assert (forall ((go Int) (ga Int) (gb Int) (gm Int) (gradeo Int) (gradea Int) (gradeb Int) (gradem Int) (ro Int) (ra Int) (rb Int) (rm Int) (gb1 Int) (gm1 Int)) (=> (and (= gm1 2) (= gb1 2) (Q_n0_1 go ga gb gm gradeo gradea gradeb gradem ro ra rb rm)) (Q_n2 go ga gb1 gm1 gradeo gradea gradeb gradem ro ra rb rm))))
...
(assert (forall ((go Int) (ga Int) (gb Int) (gm Int) (gradeo Int) (gradea Int) (gradeb Int) (gradem Int) (ro Int) (ra Int) (rb Int) (rm Int)) (=> (Q_n2_1 go ga gb gm gradeo gradea gradeb gradem ro ra rb rm) (Q_n2_1b go ga gb gm gradeo gradea gradeb gradem ro ra rb rm))))
(assert (forall ((go Int) (ga Int) (gb Int) (gm Int) (gradeo Int) (gradea Int) (gradeb Int) (gradem Int) (ro Int) (ra Int) (rb Int) (rm Int) (ro1 Int) (ra1 Int) (rb1 Int) (rm1 Int)) (=> (and (= rm1 gm) (= rb1 gb) (= ra1 0) (= ro1 0) (Q_n2_1b go ga gb gm gradeo gradea gradeb gradem ro ra rb rm)) (Q_exit go ga gb gm gradeo gradea gradeb gradem ro1 ra1 rb1 rm1))))
