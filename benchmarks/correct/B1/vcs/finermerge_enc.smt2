...
(assert (forall ((ro Int) (ra Int) (rb Int) (rm Int) (xo Int) (xa Int) (xb Int) (xm Int) (xa1 Int)) (=> (and (= xa1 (+ xa 1)) (Q_n0_1 ro ra rb rm xo xa xb xm)) (Q_n1 ro ra rb rm xo xa1 xb xm))))
