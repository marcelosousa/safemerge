...
(assert (forall ((ro Int) (ra Int) (rb Int) (rm Int) (xo Int) (xa Int) (xb Int) (xm Int)) (=> (Q_n0 ro ra rb rm xo xa xb xm) true)))
...
(assert (forall ((ro Int) (ra Int) (rb Int) (rm Int) (xo Int) (xa Int) (xb Int) (xm Int) (xa1 Int)) (=> (Q_n0_1 ro ra rb rm xo xa xb xm) true)))
(assert (forall ((ro Int) (ra Int) (rb Int) (rm Int) (xo Int) (xa Int) (xb Int) (xm Int) (xa1 Int)) (=> (and (= xa1 (+ xa 1)) (Q_n0_1 ro ra rb rm xo xa xb xm)) (Q_n0_2 ro ra rb rm xo xa1 xb xm))))
(assert (forall ((ro Int) (ra Int) (rb Int) (rm Int) (xo Int) (xa Int) (xb Int) (xm Int) (xb1 Int) (xm1 Int)) (=> (Q_n0_2 ro ra rb rm xo xa xb xm) true)))
...
(assert (forall ((ro Int) (ra Int) (rb Int) (rm Int) (xo Int) (xa Int) (xb Int) (xm Int)) (=> (Q_n1 ro ra rb rm xo xa xb xm) true)))
(assert (forall ((ro Int) (ra Int) (rb Int) (rm Int) (xo Int) (xa Int) (xb Int) (xm Int)) (=> (Q_n1 ro ra rb rm xo xa xb xm) (Q_n2 ro ra rb rm xo xa xb xm))))
(assert (forall ((ro Int) (ra Int) (rb Int) (rm Int) (xo Int) (xa Int) (xb Int) (xm Int) (ro1 Int) (ra1 Int) (rb1 Int) (rm1 Int)) (=> (Q_n2 ro ra rb rm xo xa xb xm) true)))
