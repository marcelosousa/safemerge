...
(assert (forall ((ro Int) (ra Int) (rb Int) (rm Int) (xo Int) (xa Int) (xb Int) (xm Int) (xo1 Int) (xa1 Int) (xb1 Int) (xm1 Int)) (=> (Q_n0_1 ro ra rb rm xo xa xb xm) true)))
(assert (forall ((ro Int) (ra Int) (rb Int) (rm Int) (xo Int) (xa Int) (xb Int) (xm Int) (xo1 Int) (xa1 Int) (xb1 Int) (xm1 Int)) (=> (and (= xm1 1) (= xb1 1) (= xa1 2) (= xo1 1) (Q_n0_1 ro ra rb rm xo xa xb xm)) (Q_n0_2 ro ra rb rm xo1 xa1 xb1 xm1))))
...
(assert (forall ((ro Int) (ra Int) (rb Int) (rm Int) (xo Int) (xa Int) (xb Int) (xm Int) (ro1 Int) (ra1 Int) (rb1 Int) (rm1 Int)) (=> (Q_n1 ro ra rb rm xo xa xb xm) true)))
