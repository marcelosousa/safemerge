...
public class IndexRequest extends ReplicationRequest<IndexRequest> implements DocumentRequest<IndexRequest> {
    ...
    public Map<String, Object> sourceAsMap() {
        return XContentHelper.convertToMap(source, 0).v2();
    }
    ...
    /**
     * Set to <tt>1</tt> to force this index to use {@link OpType#CREATE}.
     */
     ...
     * be searchable. Note, heavy indexing should not set this to <tt>1</tt>. Defaults
     * to <tt>0</tt>.
     */
    ...
    public void process(MetaData metaData, @Nullable MappingMetaData mappingMd, boolean allowIdGeneration, String concreteIndex) {
        ...
        if (timestamp == null) {
            ...
            if (mappingMd != null && mappingMd.timestamp() != null) {
                ...
                if (mappingMd.timestamp().ignoreMissing() != null && mappingMd.timestamp().ignoreMissing() == 0) {
    ...
    public String toString() {
        String sSource = "_na_";
        try {
            sSource = XContentHelper.convertToJson(source, 0);
        } catch (Exception e) {
            // ignore
        }
