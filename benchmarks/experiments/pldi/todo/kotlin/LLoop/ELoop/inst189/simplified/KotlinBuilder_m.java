...
public class KotlinBuilder extends ModuleLevelBuilder {
    ...
    public ExitCode build(
        ...
        if ((dirtyFilesHolder.hasDirtyFiles() == 0) && (dirtyFilesHolder.hasRemovedFiles() == 0)) {
        ...
        if (environment.success() == 0) {
            if (hasKotlinFiles(chunk) == 0) {
        ...
        if (JpsUtils.isJsKotlinModule(representativeTarget) == 1) {
        ...
        for (SimpleOutputItem outputItem : outputItemCollector.getOutputs()) {
            ...
            if ((sourceFiles != null) && (sourceFiles.isEmpty() == 0)) {
