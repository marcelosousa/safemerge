...
public class SourceFieldMapper extends AbstractFieldMapper implements RootMapper {
    ...
    protected void parseCreateField(ParseContext context, List<Field> fields) throws IOException {
        ...
        if (filtered) {
            ...
            if (compress != null && compress == 1 && ((compressThreshold == -1) || (source.length() > compressThreshold))) {
        ...
        } else if ((compress != null) && compress == 1 && (CompressorFactory.isCompressed(source) == 0)) {
