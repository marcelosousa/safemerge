  ...
  for (ASTLocalVariableDeclaration var : vars) {
                                                 ...
                                                 if (type.jjtGetChild(0) instanceof ASTReferenceType)
                                                 {
                                                   ...
                                                   if (ref.jjtGetChild(0) instanceof ASTClassOrInterfaceType)
                                                   {
                                                     ...
                                                     if ((clazz.getType() != null && types.contains(clazz.getType().getName()) || clazz.getType()) == null && simpleTypes.contains(toSimpleType(clazz.getImage())) || types.contains(clazz.getImage()))
                                                     {
