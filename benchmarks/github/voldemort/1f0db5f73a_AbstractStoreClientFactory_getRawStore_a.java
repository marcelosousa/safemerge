class AbstractStoreClientFactory{ 
 void getRawStore() {
  ...
  Store<ByteArray, byte[], byte[]> store = routedStoreFactory.create(cluster, storeDef, clientMapping, nonblockingStores, repairReads, clientZoneId, getFailureDetector());
  if (isJmxEnabled)
  {
