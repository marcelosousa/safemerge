{
  ...
  pipeline.addEventAction(Event.CONFIGURED, new PerformParallelRequests<Boolean, BasicPipelineData<Boolean>>(pipelineData, (isHintedHandoffEnabled() ? Event.RESPONSES_RECEIVED : Event.COMPLETED), key, null, failureDetector, storeDef.getPreferredWrites(), storeDef.getRequiredWrites(), timeoutMs, nonblockingStores, hintedHandoff, version, Event.INSUFFICIENT_SUCCESSES, Event.INSUFFICIENT_ZONES));
