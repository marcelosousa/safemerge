{
  ...
  if (zoneRoutingEnabled)
    pipeline.addEventAction(Event.INSUFFICIENT_ZONES, new PerformZoneSerialRequests<Boolean, BasicPipelineData<Boolean>>(pipelineData, (repairReads ? Event.RESPONSES_RECEIVED : Event.COMPLETED), key, failureDetector, innerStores, blockingDelete));
