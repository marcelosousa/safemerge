{
  ...
  try
  {
    ...
    Store<ByteArray, byte[], byte[]> store = routedStoreFactory.create(cluster, def, nodeStores, nonblockingStores, true, cluster.getNodeById(localNode).getZoneId(), failureDetector);
