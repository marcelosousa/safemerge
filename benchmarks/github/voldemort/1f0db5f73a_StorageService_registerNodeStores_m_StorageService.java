class StorageService{ 
 void registerNodeStores() {
  ...
  try
  {
    ...
    Store<ByteArray, byte[], byte[]> store = routedStoreFactory.create(cluster, def, nodeStores, nonblockingStores, null, true, cluster.getNodeById(localNode).getZoneId(), failureDetector);
