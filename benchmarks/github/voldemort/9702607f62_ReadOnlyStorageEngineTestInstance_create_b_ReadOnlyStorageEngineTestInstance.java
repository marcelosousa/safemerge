{
  ...
  for (int i = 0 ; i < numNodes ; i++)
  {
    ...
    Store<ByteArray, byte[]> innerStore = new CompressingStore(new ReadOnlyStorageEngine("test", strategy, router, i, currNode, 1), keyCompressionStrat, valueCompressionStrat);
