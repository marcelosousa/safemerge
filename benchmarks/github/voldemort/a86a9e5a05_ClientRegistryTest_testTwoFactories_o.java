class ClientRegistryTest{ 
 void testTwoFactories() {
  ...
  ClientConfig clientConfig2 = new ClientConfig().setMaxThreads(4).setMaxTotalConnections(4).setMaxConnectionsPerNode(4).setBootstrapUrls((SERVER_LOCAL_URL + serverPorts[0])).setClientContextName(CLIENT_CONTEXT_NAME2).setClientRegistryRefreshInterval(CLIENT_REGISTRY_REFRSH_INTERVAL).setEnableLazy(false);
