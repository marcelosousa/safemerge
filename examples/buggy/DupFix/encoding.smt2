...
(assert (forall ((ro Int) (ra Int) (rb Int) (rm Int) (xo Int) (xa Int) (xb Int) (xm Int) (xb1 Int)) (=> (and (= xb1 (+ xb 1)) (Q_n1_1 ro ra rb rm xo xa xb xm)) (Q_n2 ro ra rb rm xo xa xb1 xm))))
