...
(declare-fun Q_n2_0a (Int Int Int Int Int Int Int Int) Bool)
(declare-fun Q_n3 (Int Int Int Int Int Int Int Int) Bool)
(declare-fun Q_n3_0a (Int Int Int Int Int Int Int Int) Bool)
(declare-fun Q_n4 (Int Int Int Int Int Int Int Int) Bool)
(declare-fun Q_n4_0a (Int Int Int Int Int Int Int Int) Bool)
...
(assert (forall ((ao Int) (aa Int) (ab Int) (am Int) (no Int) (na Int) (nb Int) (nm Int)) (=> (Q_n2 ao aa ab am no na nb nm) true)))
(assert (forall ((ao Int) (aa Int) (ab Int) (am Int) (no Int) (na Int) (nb Int) (nm Int)) (=> (Q_n2 ao aa ab am no na nb nm) (Q_n2_0a ao aa ab am no na nb nm))))
(assert (forall ((ao Int) (aa Int) (ab Int) (am Int) (no Int) (na Int) (nb Int) (nm Int)) (=> (Q_n2_0a ao aa ab am no na nb nm) (= (<= no 10) (<= aa 10) (<= nb 10)))))
(assert (forall ((ao Int) (aa Int) (ab Int) (am Int) (no Int) (na Int) (nb Int) (nm Int)) (=> (and (<= nb 10) (<= aa 10) (<= no 10) (Q_n2_0a ao aa ab am no na nb nm)) (Q_n3 ao aa ab am no na nb nm))))
(assert (forall ((ao Int) (aa Int) (ab Int) (am Int) (no Int) (na Int) (nb Int) (nm Int)) (=> (Q_n3 ao aa ab am no na nb nm) true)))
(assert (forall ((ao Int) (aa Int) (ab Int) (am Int) (no Int) (na Int) (nb Int) (nm Int)) (=> (Q_n3 ao aa ab am no na nb nm) (Q_n3_0a ao aa ab am no na nb nm))))
(assert (forall ((ao Int) (aa Int) (ab Int) (am Int) (no Int) (na Int) (nb Int) (nm Int) (aa1 Int) (no1 Int) (nb1 Int)) (=> (Q_n3_0a ao aa ab am no na nb nm) true)))
(assert (forall ((ao Int) (aa Int) (ab Int) (am Int) (no Int) (na Int) (nb Int) (nm Int) (aa1 Int) (no1 Int) (nb1 Int)) (=> (and (= nb1 (+ nb 1)) (= aa1 (+ aa 1)) (= no1 (+ no 1)) (Q_n3_0a ao aa ab am no na nb nm)) (Q_n1 ao aa1 ab am no1 na nb1 nm))))
(assert (forall ((ao Int) (aa Int) (ab Int) (am Int) (no Int) (na Int) (nb Int) (nm Int)) (=> (Q_n4 ao aa ab am no na nb nm) true)))
(assert (forall ((ao Int) (aa Int) (ab Int) (am Int) (no Int) (na Int) (nb Int) (nm Int)) (=> (Q_n4 ao aa ab am no na nb nm) (Q_n4_0a ao aa ab am no na nb nm))))
(assert (forall ((ao Int) (aa Int) (ab Int) (am Int) (no Int) (na Int) (nb Int) (nm Int)) (=> (Q_n4_0a ao aa ab am no na nb nm) (= (> no 10) (> aa 10) (> nb 10)))))
(assert (forall ((ao Int) (aa Int) (ab Int) (am Int) (no Int) (na Int) (nb Int) (nm Int)) (=> (and (> nb 10) (> aa 10) (> no 10) (Q_n4_0a ao aa ab am no na nb nm)) (Q_exit ao aa ab am no na nb nm))))
...
(assert (forall ((ao Int) (aa Int) (ab Int) (am Int) (no Int) (na Int) (nb Int) (nm Int)) (=> (Q_n3 ao aa ab am no na nb nm) (and (and (or (= ao aa) (= am aa)) (or (= ao ab) (= am ab)) (or (not (= ao aa)) (not (= ao ab)) (= am ao))) (and (or (= no na) (= nm na)) (or (= no nb) (= nm nb)) (or (not (= no na)) (not (= no nb)) (= nm no)))))))
(check-sat)
