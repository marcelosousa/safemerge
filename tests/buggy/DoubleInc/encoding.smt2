...
(assert (forall ((ro Int) (ra Int) (rb Int) (rm Int) (xo Int) (xa Int) (xb Int) (xm Int) (ro1 Int) (xa1 Int) (xb1 Int) (xm1 Int)) (=> (and (= xm1 (+ xm 1)) (= xb1 (+ xb 1)) (= xa1 (+ xa 1)) (= ro1 xo) (Q_n0_1 ro ra rb rm xo xa xb xm)) (Q_n0_2 ro1 ra rb rm xo xa1 xb1 xm1))))
...
(assert (forall ((ro Int) (ra Int) (rb Int) (rm Int) (xo Int) (xa Int) (xb Int) (xm Int) (ra1 Int) (rb1 Int) (rm1 Int)) (=> (and (= rm1 (+ xm 1)) (= rb1 (+ xb 1)) (= ra1 xa) (Q_n0_2 ro ra rb rm xo xa xb xm)) (Q_n1 ro ra1 rb1 rm1 xo xa xb xm))))
