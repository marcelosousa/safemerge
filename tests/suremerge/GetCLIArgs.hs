...
p =
  let n0 = ("n0", Goto ["n1", "n9"])
      ...
      n8 = ("n8", Assign "argi" $ Op (V "argi") Add (C 1))
      n9 = ("n9", Goto ["n0"])

      n10 = ("n10", Assume $ Op (V "argi") Ge (V "args_length"))
      n11 = ("n11", Goto ["exit"]) 
...
a =
  let n8_1a = ("n8_1a", Goto ["n8_2a", "n8_5a"])
      ...
      n8_4a = ("n8_4a", Goto ["n8_6a"])
      n8_5a = ("n8_5a", Assume $ Op (V "arg") Neq (C 1))
      n8_6a = ("n8_6a", Assign "argi" $ Op (V "argi") Add (C 1))
      n8_7a = ("n8_7a", Goto ["n0"])

      eprog = ("n8_1a", fromList [n8_1a, n8_2a, n8_3a, n8_4a, n8_5a, n8_6a, n8_7a], "n8_7a")
...
b =
  let n6_1b = ("n6_1b", Assign "errorCode_Ab" (V "arg"))
      ...
      n8_5b = ("n8_5b", Goto ["n8_7b"])
      n8_6b = ("n8_6b", Assume $ Op (V "arg") Neq (C 1))
      n8_7b = ("n8_7b", Assign "argi" $ Op (V "argi") Add (C 1))
      n8_8b = ("n8_8b", Goto ["n0"])

      eprog1 = ("n6_1b", fromList [n6_1b, n6_2b], "n6_2b")
      eprog2 = ("n8_1b", fromList [n8_1b, n8_2b, n8_3b, n8_4b, n8_5b, n8_6b, n8_7b, n8_8b], "n8_8b")
