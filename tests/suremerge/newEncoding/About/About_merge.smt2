...
(assert (forall ((xo Int) (xa Int) (xb Int) (xm Int) (yo Int) (ya Int) (yb Int) (ym Int) (zo Int) (za Int) (zb Int) (zm Int)) (=> (Q_exit xo xa xb xm yo ya yb ym zo za zb zm) (Q_n2 xo xa xb xm yo ya yb ym zo za zb zm))))
...
(assert (forall ((xo Int) (xa Int) (xb Int) (xm Int) (yo Int) (ya Int) (yb Int) (ym Int) (zo Int) (za Int) (zb Int) (zm Int) (yo1 Int) (ya1 Int)) (=> (and (= ya1 2) (= yo1 2) (Q_n1_1b xo xa xb xm yo ya yb ym zo za zb zm)) (Q_exit xo xa xb xm yo1 ya1 yb ym zo za zb zm))))
(assert (forall ((xo Int) (xa Int) (xb Int) (xm Int) (yo Int) (ya Int) (yb Int) (ym Int) (zo Int) (za Int) (zb Int) (zm Int) (zo1 Int) (za1 Int) (zb1 Int) (zm1 Int)) (=> (and (= zm1 3) (= zb1 3) (= za1 3) (= zo1 3) (Q_n2 xo xa xb xm yo ya yb ym zo za zb zm)) (Q_exit xo xa xb xm yo ya yb ym zo1 za1 zb1 zm1))))
